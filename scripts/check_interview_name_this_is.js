/**
 * Regressions: the name question must not persist the introducer "This"
 * from replies like "This is Maya". There is no later UI to change the name,
 * and needs() then skips the topic forever.
 *
 * Distinct from interview consent words (yes/ok/sure, PR #38), hedges
 * ("I'm not sure", "call me later", PR #41), and call-me / I'm wrappers
 * ("Just call me Alex", PR #43). This is the "this is <name>" self-introduction.
 *
 * Run from repo root:
 *   node scripts/check_interview_name_this_is.js
 */
...
async function main() {
  for (const [text, expect] of [
    ...
    ["this is Alex", "Alex"],
    ["This is Maya.", "Maya"],
    ["Hi this is Jordan", "Jordan"],
    ["Hey, this is Priya", "Priya"],
    ["Hello this is Sam", "Sam"]
  ]) {
  ...
  console.log("OK interview-name this-is checks passed");
}
